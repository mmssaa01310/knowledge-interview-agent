...
def _canonical_intent_system_prompt() -> str:
    return (
        ...
        "分類候補:\n"
        "- ANSWER: 現在の質問への回答や追加情報\n"
        "- QUESTION_TO_ASSISTANT: AIへの質問、質問の意味・範囲・答え方の確認\n"
        "- CLARIFICATION_REQUEST: 現在の質問を明確にしてほしいという聞き返し\n"
        ...
        "- CONVERSATION_REQUEST: インタビュー進行そのものへの操作・依頼\n"
        "- IRRELEVANT: 現在の質問と関係しない発話\n"
        "- OTHER: 上記に明確に該当しない発話\n\n"
        "「担当領域ってどの範囲のこと？」のように質問の意味を尋ねる発話は、\n"
        "回答不足ではなくQUESTION_TO_ASSISTANTまたはCLARIFICATION_REQUESTです。\n"
        "「大丈夫です」「はい、合っています」はCONFIRMATION、「違います」はREJECTIONです。\n"
